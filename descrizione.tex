...
\begin{itemize}
    ...
    Un algoritmo è localizzato da un \emph{Path} e da una \emph{GitBranch}: supporremmo infatti che sia tutti gli algoritmi siano registrati in un VCS e condivisi con questo metodo tra le varie macchine.
